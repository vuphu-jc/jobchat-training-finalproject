package com.example.minijobchat.ui.recyclerview
...
interface CustomRecyclerView {
    ...
    class ViewHolderFactory {
        companion object {
            private const val ERROR_THROWN =
                "Error. Please insert mapping view type with class and resource"
        }
        ...
        fun createViewHolder(context: Context, parent: ViewGroup, viewType: Int): ViewHolder {
            ...
            return Class.forName(mapping.first).getConstructor(
                Context::class.java,
                View::class.java
            )
